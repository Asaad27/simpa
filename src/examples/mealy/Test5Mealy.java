...
public class Test5Mealy {
//
	public static Mealy getAutomata() {
		Mealy test = new Mealy("Test_5_States");
		...
		test.addTransition(new MealyTransition(test, s1, s1, "a", "0"));
		test.addTransition(new MealyTransition(test, s1, s2, "b", "1"));

		test.addTransition(new MealyTransition(test, s2, s3, "a", "1"));
		test.addTransition(new MealyTransition(test, s2, s2, "b", "0"));

		test.addTransition(new MealyTransition(test, s3, s2, "a", "0"));
		test.addTransition(new MealyTransition(test, s3, s4, "b", "0"));

		test.addTransition(new MealyTransition(test, s4, s1, "a", "0"));
		test.addTransition(new MealyTransition(test, s4, s5, "b", "1"));

		test.addTransition(new MealyTransition(test, s5, s1, "a", "1"));
		test.addTransition(new MealyTransition(test, s5, s4, "b", "0"));
