...
public class Attribute <T extends Comparable<T>> {
	...
	public final static Attribute<Integer>	PROVIDED_TRACE_LENGTH =     new Attribute<Integer>(	"length of provided trace",						true,	Units.SYMBOLS,		true,	false,	false);
	...
	public final static Attribute<Boolean>	USE_RESET =					new Attribute<Boolean>(	"using reset for inference",					false,	Units.BOOLEAN,		false,	true,	false);
