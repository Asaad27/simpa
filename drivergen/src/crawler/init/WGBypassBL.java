...
public class WGBypassBL extends DriverGenerator{
	
	private String screen = null;
	
	public WGBypassBL() throws JsonParseException, JsonMappingException, IOException{
		super("webgoat_bypass_bl.json");
		initConnection();
		reset();
