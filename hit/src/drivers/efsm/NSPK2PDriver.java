...
public class NSPK2PDriver extends EFSMDriver {
	...
	public HashMap<String, List<ArrayList<Parameter>>> getDefaultParamValues(){
		...
		//m1
		{
			...
			params.add(Utils.createArrayList(new Parameter("666", Types.NUMERIC), new Parameter("5", Types.NUMERIC)));
		...
		{
			params = new ArrayList<ArrayList<Parameter>>();	
			params.add(Utils.createArrayList(new Parameter("666", Types.NUMERIC), new Parameter("10", Types.NUMERIC)));
	...
	public TreeMap<String, List<String>> getParameterNames(){
		...
		defaultParamNames.put("m1", Utils.createArrayList("default1", "sendedID"));
		defaultParamNames.put("m2", Utils.createArrayList("receivedID", "receivedSessionID"));
		defaultParamNames.put("m3", Utils.createArrayList("default2", "sendedSessionID"));
